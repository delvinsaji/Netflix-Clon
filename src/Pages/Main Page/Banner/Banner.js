    ...
    >
      ...
      <div className="x">
        ...
        <button
          className="x_button"
          onClick={() => {
            axios.post(`http://127.0.0.1:8000/api/postwatchlist/${props.id}`, {
              movie_name: trend_data
                ? trend_data.results[movie_num].original_title
                  ? trend_data.results[movie_num].original_title
                  : trend_data.results[movie_num].original_name
                : "null",
              movie_id: trend_data ? trend_data.results[movie_num].id : "null",
            });
          }}
        >
          Watchlist
